<?php
class Toko_sepatu01 extends CI_Controller
{
    public function index()
    {$this->load->view('form_toko_sepatu01' );}
    ...
    public function pesan()
    {
        ...
        if ($this->form_validation->run() !=true){$this->load->view('form_toko_sepatu01');}
        else
        {
            $data = [
            ...
            $this->load->view('Data_toko_sepatu01' , $data);
        }
    }
}