<?php
class Toko_sepatuFix extends CI_Controller
{
    public function index()
    {$this->load->view('form_toko_sepatuFix' );}
    ...
    public function pesan()
    {
        ...
        if ($this->form_validation->run() !=true){$this->load->view('form_toko_sepatu1');}
        else
        {
            $data = [
            ...
            $this->load->view('Data_toko_sepatu1' , $data);
        }
    }
}