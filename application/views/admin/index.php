    ...
    <div class="col-xl-3 col-md-6 mb-4">       
        <div class="card border-left-primary shadow h-100 py-2 bg-warning">         
            ...
            <div class="col-auto">               
                ...
                <i class="fas fabook fa-3x text-primary"></i></a>             
            </div>           
        </div>         
    </div>       
</div>     
                ...
                <div class="row no-gutters align-items-center">             
                    <div class="col mr-2">               
                        ...
                        <div class="col-auto">               
                            ...
                            <i class="fas fauser-tag fa-3x text-success"></i></a>             
                        </div>           
                    </div>         
                </div>       
            </div>     
        ...
        <div class="card border-left-warning shadow h-100 py-2 bg-success">         
            <div class="card-body">           
              ...
              <div class="h1 mb-0 font-weight-bold text-white">                 
                ...
                <div class="col-auto">               
                    <a href="<?= base_url('user'); ?>">
                    <i class="fas fashopping-cart fa-3x text-danger"></i></a>             
                </div>           
            </div>         
        </div>       
    </div>     
...
<div class="row">     
    ...
    <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">       
        <div class="page-header">         
            ...
            <a href="<?= base_url('buku'); ?>">
            <i class="fas fa-search text-primary mt-2 float-right"> Tampilkan</i></a>       
        </div>       
